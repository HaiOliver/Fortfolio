    ...
    <Tilt className="parallax-effect-jos" perspective={500}>
      <div className="inner-element">
        ...
        <div className="text-jos">
          <ul>
            <li>
              Learned to interact with clients, present designs, and handle
              feedback on work completed.
            </li>
            <li>
              Reviewed and improved code. Enhanced the functionality and user
              experience of the CMS.
            </li>
