...
class SuperStunningEffect extends Component {
  componentDidMount() {
    // === THREE.JS CODE START ===
    window.onload = init;
    ...
    function init() {
      ...
      l1.load(
        "https://images.pexels.com/photos/2408022/pexels-photo-2408022.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
        function (img) {
          slide.setImage(img);
        }
      );
      ...
      l2.load(
        "https://images.pexels.com/photos/4834890/pexels-photo-4834890.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
        function (img) {
          slide2.setImage(img);
        }
      );
